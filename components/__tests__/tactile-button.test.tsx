...
import { TactileButton, tactileButtonVariants } from "../tactile-button"
...
describe("TactileButton", () => {
  ...
  it("is disabled when disabled prop is passed", () => {
    const handleClick = vi.fn()
    render(<TactileButton disabled onClick={handleClick}>Disabled</TactileButton>)
    const button = screen.getByRole("button")
  ...
  it("exports tactileButtonVariants for external use", () => {
    expect(tactileButtonVariants).toBeDefined()
    expect(typeof tactileButtonVariants).toBe("function")
  })
})
