          ...
          >
            <div className="flex flex-col h-full items-center justify-center">
              ...
              >
                ...
                >
                  {/* ⌘K palette trigger — magnetic (desktop-only) via
                      MagneticButton; ghost variant + overrides keep the
                      mobile-menu text-button look. */}
                  <MagneticButton
                    variant="ghost"
                    type="button"
                    onClick={() => {
                    ...
                    className="font-serif text-4xl text-foreground transition-colors hover:text-primary-text active:scale-95 min-h-[44px] inline-flex items-center h-auto px-0 py-0 rounded-none"
                  >
                    Commands
