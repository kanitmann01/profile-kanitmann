...
describe("Sitemap", () => {
  ...
  it("includes all published articles", () => {
    ...
    expect(urls).toContain("https://www.kanit.codes/articles/bios-issues-ubuntu")
    expect(urls).toContain("https://www.kanit.codes/articles/ccrb-allegations-analysis")
    expect(urls).toContain("https://www.kanit.codes/articles/data-viz-analysis")
