...
export const experiences: Experience[] = [
    ...
    roles: [
      {
        ...
        duration: "1 yr 4 mos",
        workMode: "Hybrid",
        description: "Led deployment and optimization of Citrix virtual infrastructure across regional data centers, improving resource utilization and reducing system latency. Contributed to migrating approximately 2,000 servers from on-premises infrastructure to Google Cloud Platform (GCP) and collaborated with security teams to harden the hybrid cloud environment.",
        skills: ["Citrix Workspace", "Citrix Virtual Apps", "Google Cloud Platform", "Cloud Migration", "Database Management"],
        achievements: [
      ...
      },
      {
        ...
        duration: "8 mos",
        workMode: "On-site",
        description: "Managed and maintained cloud and infrastructure systems for Ericsson Global, ensuring reliability, security, and performance while supporting cross-functional teams.",
  ...
  },
  {
    ...
    duration: "3 mos",
    workMode: "On-site",
    description: "Streamlined employee transfer and joining policies by designing a database schema and prototyping an internal portal. Partnered with HR to document policy workflows and improve discoverability.",
  ...
  },
  {
    ...
    duration: "11 mos",
    workMode: "On-site",
    description: "Served as management board member for VIT's premier robotics organization with 500+ members. Led the design department, teaching Adobe Creative Suite and Figma to 75+ students and mentoring them through club projects.",
  ...
  },
  {
    ...
    duration: "4 mos",
    workMode: "On-site",
    description: "Developed and tested firmware for embedded systems and microcontrollers, collaborating with cross-functional teams on automation systems, IoT devices, and motor control applications.",
